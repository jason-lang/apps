...
+!distributeAimVertices([pivot(V1, V2, Value) | TV], [], [A1, A2 | TA]) //There is no island
<-
	.print("#DISTRIBUTE# There is no islands ", V1, " ", V2);
	.send(A1, achieve, gotoPivotVertex(V1, pivot(V1, V2, Value)));
	.send(A2, achieve, gotoPivotVertex(V2, pivot(V1, V2, Value)));
...
+!distributeAimVertices([pivot(V1, V2, Value) | TV], [island(VIsland, VerticesIsland, ValueIsland) | []], [A1, A2 | TA]): //There is just one island
...
<-
	...
	!distributeAimVertices([pivot(V1, V2, Value) | TV], [], TA).
	
+!distributeAimVertices([pivot(V1, V2, Value) | TV], [island(VIsland1, VerticesIsland1, ValueIsland1), island(VIsland2, VerticesIsland2, ValueIsland2) | TI], [A1, A2 | TA]): //There is more islands
...
<-
	...
	!distributeAimVertices([pivot(V1, V2, Value) | TV], TI, TA).
