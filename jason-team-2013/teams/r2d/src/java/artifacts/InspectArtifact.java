...
public class InspectArtifact extends Artifact {
	...
	void addEntity(String entity, String type, int maxHealth, int strength, int visRange) {
		...
		//Remove the old observable property
		ObsProperty obsOld = entityToObs.get(entity);
		if (obsOld != null) {
			entityToObs.remove(entity);
		...
		//System.out.println("Adicionado " + entity + " -> " + getObsPropertyByTemplate("entityType", o));
	}
