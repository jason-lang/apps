...
is_good_map_conquered :- step(S) & S > 300 & is_free_to_walk & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.42 & at_some_good_zone_score(0.34).
is_good_map_conquered :- step(S) & S > 150 & is_free_to_walk & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.45 & at_some_good_zone_score(0.35).
is_good_map_conquered :- step(S) & S > 80 & is_free_to_walk & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.48 & at_some_good_zone_score(0.35).
is_good_map_conquered :- step(S) & S > 25 & is_free_to_walk & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.5 & at_some_good_zone_score(0.35).
