...
//TODO pegar dos grupos ao inves de engessar... esta engessado pq nao tem as percepções do cartago
+!callGroupToArea(BestVertex, BestValue, Neighborhood, "grAlpha") <-
	.send([
			explorer1, explorer2, explorer6,
	 		...
	 		saboteur1, saboteur4
	 	], achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood)).
