...
<-
    !broadcastInspect(Entity, Type, MaxHealth, Strength, VisRange);
...
<-
    ...
    .send(SetAgents, tell,entityType(Entity, Type, _, _, _)).
+!broadcastInspect(Entity, Type, MaxHealth, Strength, VisRange): true <- true.
