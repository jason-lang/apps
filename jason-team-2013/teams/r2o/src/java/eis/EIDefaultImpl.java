...
public abstract class EIDefaultImpl implements EnvironmentInterfaceStandard,Serializable {
	 ...
	 */
 	 ...
 	 * registered.
 	 */
      protected void notifyAgents(Collection<Percept> percept, String...agents) throws EnvironmentInterfaceException {
	 ...
	 * @throws EnvironmentInterfaceException
	 */
	protected void notifyAgentsViaEntity(Collection<Percept> percept, String...pEntities) throws EnvironmentInterfaceException {
