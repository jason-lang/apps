...
*/
    ...
    public void handlePercept(String agent, Collection<Percept> percepts) {        
        try {
            ...
            //TODO remover
            if (jasonPers.length > 1000) {
            	System.out.println("Mais de mil percepts 1 : " + jasonPers.length);
            }
    ...
    protected List<Literal> addEISPercept(List<Literal> percepts, String agName) {
        ...
        //TODO remover
        if (percepts.size() > 1000) {
        	System.out.println("Mais de mil percepts 2 : " + percepts.size());
        }
