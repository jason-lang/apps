/*
 * TODO verificar vários sabotadores mesmo vértice
 */
...
+!processAfterStep(S) <- !test.
	

+!test:
	visRange(Vis) & Vis > 1 & position(MyV) & myTeam(MyTeam) &
    visibleEntity(Entity, V, Team, normal) &  Team \== MyTeam & 
    ia.getDistance(MyV, V, Distance) 
<- 
    .print("Estou em ", MyV, ". Vejo entidade ", Entity, " no vertice ", V, ". Distancia eh: ", Distance).
