...
public class MixedAgentArch extends AgArch implements AgentListenerEvents {
    ...
    public List<Literal> perceive() {
    	...
    	if (lastPercepts != null) {
    		...
    		if (fullmap) {
    			System.out.println(getAgName() + " percepções (fullmap): " + lastPercepts.length);
    			act(actionFullMap, null);
    			
    			for (Literal l : lastPercepts) {
    				System.out.println(getAgName() + l.toString());
    			}
    		} else {
    			System.out.println(getAgName() + " percepções: " + lastPercepts.length);
    		}
