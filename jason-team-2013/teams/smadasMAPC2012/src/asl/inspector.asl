...
<-
    ...
    +priorityEntity(inspector1, inspector5);
    +priorityEntity(inspector1, inspector6);
    
    +priorityEntity(inspector2, inspector3);
    +priorityEntity(inspector2, inspector4);
    +priorityEntity(inspector2, inspector5);
    +priorityEntity(inspector2, inspector6);
    
    +priorityEntity(inspector3, inspector4);
    +priorityEntity(inspector3, inspector5);
    +priorityEntity(inspector3, inspector6);

    +priorityEntity(inspector4, inspector5);
    +priorityEntity(inspector4, inspector6);
    
    +priorityEntity(inspector5, inspector6).
...
<-
    ...
    .send(inspector5, achieve, setNewEntityInspected(Entity, Type, S));
    .send(inspector6, achieve, setNewEntityInspected(Entity, Type, S)).
