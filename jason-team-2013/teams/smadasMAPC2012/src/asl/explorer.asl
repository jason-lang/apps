...
+!select_goal:
    .my_name(explorer6) & nextStepExplorerAll(X) & X < 5 & numberWaits(K)
<-  
...
+!select_goal:
    .my_name(explorer5) & nextStepExplorerAll(X) & X < 4 & numberWaits(K)
<-  
    .print("Waiting decision");
    .wait(150);
    -+numberWaits(K+1);
...
<-
    ...
    +priorityEntity(explorer1, explorer5);
    +priorityEntity(explorer1, explorer6);
    
    +priorityEntity(explorer2, explorer3);
    +priorityEntity(explorer2, explorer4);
    +priorityEntity(explorer2, explorer5);
    +priorityEntity(explorer2, explorer6);
    
    +priorityEntity(explorer3, explorer4);
    +priorityEntity(explorer3, explorer5);
    +priorityEntity(explorer3, explorer6);

    +priorityEntity(explorer4, explorer5);
    +priorityEntity(explorer4, explorer6);
    
    +priorityEntity(explorer5, explorer6).
...
<- 
    ...
    .send(explorer5,tell,nextStepExplorer(explorer1, V));
    .send(explorer6,tell,nextStepExplorer(explorer1, V));
    -+stepDone(S);
    goto(V);
    !clearDecision;
    !!synchronizeGraph.
...
<- 
    ...
    .send(explorer5,tell,nextStepExplorer(explorer2, V));
    .send(explorer6,tell,nextStepExplorer(explorer2, V));
    -+stepDone(S);
    goto(V);
    !clearDecision;
    !!synchronizeGraph.
...
<- 
    ...
    .send(explorer5,tell,nextStepExplorer(explorer3, V));
    .send(explorer6,tell,nextStepExplorer(explorer3, V));
    -+stepDone(S);
    goto(V);
    !clearDecision;
    !!synchronizeGraph.
...
@do3a[atomic]
+!do(goto(V)): 
    step(S) & .my_name(explorer4)
<- 
    .send(explorer5,tell,nextStepExplorer(explorer4, V));
    .send(explorer6,tell,nextStepExplorer(explorer4, V));
    -+stepDone(S);
    goto(V);
    !clearDecision;
    !!synchronizeGraph.
...
@do3b[atomic]
+!do(goto(V)): 
    step(S) & .my_name(explorer5)
<- 
    .send(explorer6,tell,nextStepExplorer(explorer5, V));
    -+stepDone(S);
    goto(V);
    !clearDecision;
    !!synchronizeGraph.
...
@do6a[atomic]
+!do(Act): 
    step(S) & position(V) & .my_name(explorer4) 
<-
    .send(explorer5,tell,nextStepExplorer(explorer4, V));
    .send(explorer6,tell,nextStepExplorer(explorer4, V)); 
...
@do6b[atomic]
+!do(Act): 
    step(S) & position(V) & .my_name(explorer5) 
<-
    .send(explorer6,tell,nextStepExplorer(explorer5, V)); 
    .print("I'm explorer5, and I'm notifying my friends.");
    -+stepDone(S);
    Act;
    !clearDecision;
    !!synchronizeGraph.
...
+!do(Act): 
    step(S)
<- 
    .print("I'm explorer6, and I'm notifying my friends.");
    -+stepDone(S);
    Act;
    !clearDecision;
    !!synchronizeGraph.
...
<-
    ...
    .send(explorer5, untell, farVertexAim(_, _));
    .send(explorer6, untell, farVertexAim(_, _)).
...
<-
    ...
    .send(explorer5, tell, farVertexAim(D, Path));
    .send(explorer6, tell, farVertexAim(D, Path)).
...
+!notifyFriendsFarVertex:
    probeFarVertexPath(S, D, Path) & .my_name(explorer5)
<-
    .send(explorer1, tell, farVertexAim(D, Path));
    .send(explorer2, tell, farVertexAim(D, Path));
    .send(explorer3, tell, farVertexAim(D, Path));
...
+!notifyFriendsFarVertex:
    probeFarVertexPath(S, D, Path) & .my_name(explorer6)
<-
    .send(explorer1, tell, farVertexAim(D, Path));
    .send(explorer2, tell, farVertexAim(D, Path));
    .send(explorer3, tell, farVertexAim(D, Path));
...
+!tryProposeBestCoverage(S):    
    lastCalcCoverage(N) & S - N >= 14 & .my_name(explorer3) & S < 100
<-
    -+lastCalcCoverage(S);
...
+!tryProposeBestCoverage(S):    
    lastCalcCoverage(N) & S - N >= 14 & .my_name(explorer3)
<-
    -+lastCalcCoverage(S);
    .print("COVERAGE Calculing the best coverage...");
...
<-
    ...
    .send(explorer5, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    ...
    .send(sentinel5, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    ...
    .send(inspector5, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    .send(repairer3, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    .send(repairer5, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
...
<-
    ...
    .send(explorer6, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    ...
    .send(sentinel6, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    ...
    .send(inspector6, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    .send(repairer1, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
    .send(repairer6, achieve, setNewBestCoverageSwarm(BestVertex, BestValue, Neighborhood));
