...
<-
    ...
    +priorityEntity(repairer1, repairer5);
    +priorityEntity(repairer1, repairer6);
    
    +priorityEntity(repairer2, repairer3);
    +priorityEntity(repairer2, repairer4);
    +priorityEntity(repairer2, repairer5);
    +priorityEntity(repairer2, repairer6);
    
    +priorityEntity(repairer3, repairer4);
    +priorityEntity(repairer3, repairer5);
    +priorityEntity(repairer3, repairer6);
    
    +priorityEntity(repairer4, repairer5);
    +priorityEntity(repairer4, repairer6);
    
    +priorityEntity(repairer5, repairer6);
...
<- 
    ...
    .send(repairer5,tell,nextStepRepairer(repairer1, V, S));
    .send(repairer6,tell,nextStepRepairer(repairer1, V, S));
    -+stepDone(S);
    repair(V);
    !!synchronizeGraph.
...
<-
    ...
    .send(repairer5,tell,nextStepRepairer(repairer2, V, S));
    .send(repairer6,tell,nextStepRepairer(repairer2, V, S));
    -+stepDone(S);
    repair(V);
    !!synchronizeGraph.
...
<-
    ...
    .send(repairer5,tell,nextStepRepairer(repairer3, V, S));
    .send(repairer6,tell,nextStepRepairer(repairer3, V, S));
    -+stepDone(S);
    repair(V);
    !!synchronizeGraph.
...
@do3a[atomic]
+!do(repair(V)): 
    step(S) & .my_name(repairer4)
<-
    !clearDecision; 
    .send(repairer5,tell,nextStepRepairer(repairer4, V, S));
    .send(repairer6,tell,nextStepRepairer(repairer4, V, S));
    -+stepDone(S);
    repair(V);
    !!synchronizeGraph.
...
@do3b[atomic]
+!do(repair(V)): 
    step(S) & .my_name(repairer5)
<-
    !clearDecision; 
    .send(repairer6,tell,nextStepRepairer(repairer5, V, S));
    -+stepDone(S);
    repair(V);
    !!synchronizeGraph.
...
<-
    ...
    .send(repairer5,tell,nextStepRepairer(repairer1, repairer1Skip, S));
    .send(repairer6,tell,nextStepRepairer(repairer1, repairer1Skip, S));
...
<-
    ...
    .send(repairer5,tell,nextStepRepairer(repairer2, repairer2Skip, S));
    .send(repairer6,tell,nextStepRepairer(repairer2, repairer2Skip, S));
...
<-
    ...
    .send(repairer5,tell,nextStepRepairer(repairer3, repairer3Skip, S));
    .send(repairer6,tell,nextStepRepairer(repairer3, repairer3Skip, S)); 
...
@do6a[atomic]
+!do(Act): 
    step(S) & position(V) & .my_name(repairer4) 
<-
    !clearDecision;
    .send(repairer5,tell,nextStepRepairer(repairer4, repairer4Skip, S));
    .send(repairer6,tell,nextStepRepairer(repairer4, repairer4Skip, S)); 
...
@do6b[atomic]
+!do(Act): 
    step(S) & position(V) & .my_name(repairer5) 
<-
    !clearDecision;
    .send(repairer6,tell,nextStepRepairer(repairer5, repairer5Skip, S)); 
    .print("I'm repairer5, and I'm notifying my friends.");
    -+stepDone(S);
    Act;
    !!synchronizeGraph.
...
<-
    ...
    .send(repairer5, achieve, canHelp(repairer1, Pos));
    .send(repairer6, achieve, canHelp(repairer1, Pos));
...
<-
    ...
    .send(repairer5, achieve, canHelp(AgentName, Pos));
    .send(repairer6, achieve, canHelp(AgentName, Pos));
...
<-
    ...
    .send(repairer5, achieve, resetPathProposal(AgentName));
    .send(repairer6, achieve, resetPathProposal(AgentName));
    .abolish(pathProposal(AgentName, _, _, _));
    .abolish(closest(_, AgentName, _));
    .abolish(hit(AgentName, _));
