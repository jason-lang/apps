...
public class Graph {
	...
	public List<String> getShortestPathDijkstraComplete(String vertexS,
			List<String> vertexD) {
		LinkedList<String> result = null;
	...
	public List<String> getShortestPathBFSComplete(String vertexS,
			List<String> vertexD) {
		LinkedList<String> result = null;
	...
	public void getNeighborhood(String vertex, int borderOut, int borderIn,
			List<String> listBorder, List<String> insideArea) {
		...
		int s = vertex2Integer(vertex);
		bestCoverage.execute(this, s, borderOut, borderIn, listBorderInt,
				insideAreaInt);
