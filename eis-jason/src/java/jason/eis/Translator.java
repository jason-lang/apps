...
public class Translator {
    ...
    public static void main(String[] args) throws JasonException {
        Percept p = new Percept("test", 
                new Identifier("House"), 
                new Numeral(34.5), 
                new ParameterList(new Identifier("a"), new Numeral(1)),
                new Function("student", new Identifier("Bob"), new Numeral(24)));
        
        Literal t = perceptToLiteral(p);
        System.out.println(t);
        
        System.out.println(literalToAction(t));
    }
